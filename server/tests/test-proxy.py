...
def two_proxies():
    ...
    child_proxy1.expect_exact("$")
    child_proxy1.sendline("export X=1")

    child_user.sendline("LIST")
    child_user.send('\n')
    child_user.expect_exact('\r {"method": "alert", "alert": {"devices": \["d1"\]}}\r\nu > ')
